...
//We implement sort.Interface - Len, Less, and Swap - on our type so
//we can use the sort package’s generic Sort function. Len and Swap will
//usually be similar across types and Less will hold the actual custom sorting logic.
...
//sort by converting the original fruits slice to byLength, and then use sort.Sort on that typed slice.
...
//implementing the three Interface methods on that type, and then calling sort.Sort
